...
class MainPage(Actions):
    ...
    def click_and_check_main_product(self, product):
        self._click_link(f"{product}")
        self._element((By.XPATH, f"//h1[text()='{product}']"))
        self.click_home_button()
        return self

    def add_product_to_cart(self, product):
        self._click((By.XPATH, f"//a[text()='{product}']/../../../div[@class='button-group']/button[1]"))
        return self
    ...
    def add_to_compare(self, product):
        self._click((By.XPATH, f"//a[text()='{product}']/../../../div[@class='button-group']/button[3]"))
        return self
